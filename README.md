...
### Оглавление:
- [Домашнее задание 15. Разбор выражений на Prolog](#домашнее-задание-15-разбор-выражений-на-prolog)
- [Домашнее задание 14. Деревья поиска на Prolog](#домашнее-задание-14-деревья-поиска-на-prolog)
- [Домашнее задание 13. Простые числа на Prolog](#домашнее-задание-13-простые-числа-на-prolog)
- [Домашнее задание 12. Комбинаторные парсеры](#домашнее-задание-12-комбинаторные-парсеры)
- [Домашнее задание 11. Объектные выражения на Clojure](#домашнее-задание-11-объектные-выражения-на-clojure)
- [Домашнее задание 10. Функциональные выражения на Clojure](#домашнее-задание-10-функциональные-выражения-на-clojure)
- [Домашнее задание 9. Линейная алгебра на Clojure](#домашнее-задание-9-линейная-алгебра-на-clojure)
- [Домашнее задание 8. Обработка ошибок на JavaScript](#домашнее-задание-8-обработка-ошибок-на-javascript)
- [Домашнее задание 7. Объектные выражения на JavaScript](#домашнее-задание-7-объектные-выражения-на-javascript)
- [Домашнее задание 6. Функциональные выражения на JavaScript](#домашнее-задание-6-функциональные-выражения-на-javascript)
...
6. **Code Golf**
    ...
    4. Подача решений через [чат](https://t.me). Решение должно быть корректно отформатировано и начинаться с `;Solution номинация длина`. Например, `;Solution det-2 1000`.
...
4. **Сложный вариант.** Требуется дополнительно написать функцию `parse`, осуществляющую разбор выражений, записанных в [обратной польской записи](https://ru.wikipedia.org/wiki/Обратная_польская_запись). Например, результатом
